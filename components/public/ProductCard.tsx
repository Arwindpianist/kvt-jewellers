    ...
    >
      <HoverCard>
        ...
        <Link href={`/product/${product.id}`}>
          ...
          <motion.h3
            className="mb-2 font-serif text-xl font-semibold line-clamp-2 group-hover:text-brand-500 transition-colors"
            whileHover={{ x: 4 }}
          ...
          >
            ...
            <div className="flex items-center justify-between">
              <motion.span
                className="font-semibold text-lg gold-gradient-text"
                initial={{ scale: 0.9 }}
                animate={{ scale: 1 }}
                transition={{ delay: index * 0.1 + 0.3 }}
              >
